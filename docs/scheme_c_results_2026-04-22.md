...
4. 主表方法：`periodic`、`security_risk`、`security_margin`、`rollout_joint`。
5. 验证 seed：`62-81`。
...
1. `paper_hard_holdoutfit`: 最高 secrecy 是 `periodic` (1.2948)，最低 outage 是 `security_risk` (0.9432)，最快方法是 `security_risk` (100.96 ms/slot)。
